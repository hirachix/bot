...
async function setTemplateMenu(hirako, type, m, prefix, setv, db, options = {}) {
...
╰──────❍`
    ...
    let imgUrl = 'https://files.catbox.moe/ytz0gm.jpg';

    // 1️⃣ Kirim image + buttons
    await hirako.sendButtonMsg(m.chat, {
        image: { url: imgUrl },
        text: `Halo @${m.sender.split('@')[0]}\n` + text,
        footer: ucapanWaktu,
